...
public class MotwinFacade {
     ...
     */
    public static final String            DATABASE_NAME = "ContextAwareDemoMultiProfileAndroidDB";
    /**
     ...
     * Can be null.
     */
    public static final String            MAPPING       = "mapping.properties";
    ...
    private static TimerTask              destroyTask;
    ...
    /**
     * Set the current Activity of the application. Current activity is stored
     * by the Facade in order to be able to perform actions that require an
     * Activity (such as displaying AlertDialog)
     */
     ...
     * have initialized the settings by calling {@link initSettings}
     * 
     ...
     * your must have initialized the settings by calling {@link initSettings}
     * 
     * @return the clientChannel
     */
    ...
    public static void destroy() {
        ...
        // Schedule destroy of used resources after 1 second
        Timer timer = new Timer();
        timer.schedule(destroyTask, 1 * 1000);
    }
